...
const GRASSROOTS_TYPES = [
  ...
  { value: "pickup", label: "Pickup Group" },
];
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="sticky top-0 z-40 bg-white border-b border-gray-200">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold">Submit Team</h1>
        </div>
      </div>

      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        <div className="bg-white p-4 rounded-xl border border-gray-200 space-y-4">
          <h2 className="font-semibold text-gray-900">Team Details</h2>
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., Charleston United FC"
          ...
          <div>
            ...
            <input
              ...
              placeholder="charleston-united-fc"
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setFormData(prev => ({ ...prev, parentLeagueId: e.target.value }))}
              className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1a2d5c]/50"
            ...
            <p className="text-xs text-gray-500 mt-1">Leave empty if independent team</p>
          </div>
